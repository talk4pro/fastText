...
namespace fasttext {
    ...
    void FastText::predictGroupNumber(std::istream &in, int32_t k,
                                      FastText::type_proba2groupNumber &modelPredictions) const {
    ...
    void FastText::initDictionnaryBeforeTraining(){
    ...
    void FastText::train(std::shared_ptr<Args> args) {
        try {
            setArgs(args);
            initDictionnaryBeforeTraining();
            initInputBeforeTraining();
            initOutputBeforeTraining();
            training();
            saveModelAfterTraining();
        }
